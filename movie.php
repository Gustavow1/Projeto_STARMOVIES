...
<div id="main-container" class="container-fluid">
    <div class="row">
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            ...
            <!-- Verifica se habilita a review pro usuário -->
            <?php if(!empty($userData) && !$userOwnsMovie && !$alreadyReviewed): ?>
            <div class="col-md-12" id="review-form-container"><h4>Envie sua avaliação</h4>
                <p class="page-description">Preencha sua avaliação sobre o filme</p>
                <form action="<?= $BASE_URL ?>review_process.php" id="review-form" method="POST" type="create">
