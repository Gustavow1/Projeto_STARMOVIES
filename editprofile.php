                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control disabled pointer" id="email" name="email" placeholder="Digite seu E-mail" value="<?= $userData->email ?>">
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="bio" id="bio" rows="5" placeholder="Conte um pouco mais sobre você."><?= $userData->bio ?></textarea>
                        </div>
                    </div>
                </div>
            </form>
